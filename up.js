...
const NEW_AUTHORITY = '2BAnwcKZHzohvMjwZ4ekxN2vmrgLF955d8U1cw1XvHVz';
const COLLECTION_ADDRESS = 'EM7JbudMTXS3WACAsssN5YbrzNNVKJdCvQKgtSX3HKGj';
...
async function transferUpdateAuthority() {
  try {
    ...
    const tx = await approveCollectionPluginAuthority(umi, {
